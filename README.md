...
105 sounds · half made by code, half real audio · pairs automatically with the Super Casual UI Kit.

## Use it in a game (no install)

```html
<script src="https://cdn.jsdelivr.net/gh/advme/pixelfork-sfx-library@v0.2.0-A/dist/sfx.js"></script>
